    ...
    <section className='about'>
      ...
      <div className='about__content'>
        ...
        <p>
          ...
          <br/>
          <br/>
          &emsp;A engenharia me proporcionou uma base para a resolução de problemas e habilidades analíticas, e ao longo do tempo,
          minha paixão pela tecnologia e o campo da programação me cativaram profundamente.
          <br/>
          <br/>
          &emsp;Foi assim que dei início à minha jornada na Trybe, onde venho aprimorando minhas habilidades em desenvolvimento web.
        </p>
      </div>
    </section>
  );
