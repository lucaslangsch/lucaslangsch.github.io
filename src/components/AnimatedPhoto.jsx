...
function AnimatedPhoto() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -10 100 120" width="80%" class="image" aria-hidden="true">
      ...
      <g clip-path="url(#maskImage)" transform="translate(0 -7)">
        <image clip-path="url(#maskBackground)" width="190" height="150" x="50" y="0" href={back} transform="translate(-90 -31)" />
        <image width="100%" height="100%" x="0" y="0" fill="none" loading="lazy" class="image__foreground" href={lucas} />
      </g>
    </svg>
  );
}
